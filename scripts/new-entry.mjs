...
const main = async () => {
  ...
  const topic = await ask(
    "Topic (two-of-us | miu-notes | oyirinframes | grey-h | grown-up-yap | sad-music | film-visuals | random-numbers | screenshots | trash-bin | quotes | memes | taste-yap | vid-viu-viu)",
    "two-of-us"
  );
